...
Este siguiente heatmap muestra el **espacio global de costos**, donde se representa el **costo promedio por muestra según número total de muestras (N) y corridas (R)**
...
Configuraciones con costos absolutos similares pueden presentar eficiencias relativas muy distintas, dependiendo de su posición dentro de cada régimen de corridas.
