...
**Delivery 4**: [Apéndice experimental- Fase 1](appendix-experimental/fase1-havanna.qmd). [Apéndice experimental- Fase 2](appendix-experimental/fase2-rbk.qmd). 
...
La @fig-tiempos muestra la **evolución temporal** de producción de bases (**A**) y lecturas (**B**) producidas en el [Ensayo Havanna ](appendix-experimental/fase1-havanna.qmd#sec-Havanna-assay). Como puede observarse, tanto las bases como las lecturas —en sus versiones totales (*estimated*) y filtradas por calidad (*passed*)— presentan un **crecimiento continuo y aproximadamente lineal** a lo largo del tiempo, lo que indica un rendimiento estable del flow cell durante la corrida.
