...
1. Library Original: [[Ligation sequencing amplicons - Native Barcoding Kit 24 V14](https://nanoporetech.com/document/ligation-sequencing-amplicons-native-barcoding-v14-sqk-nbd114-24). 
1. Library RBK: [Rapid Barcoding Kit 24 V14](https://store.nanoporetech.com/rapid-barcoding-sequencing-kit-24-v14.html)  
1. Extension RAA114: [Adaptador Rápido Auxiliar V14](https://store.nanoporetech.com/rapid-adapter-auxiliary-v14.html) 
1. [Reporte Havanna - FCEN](inputs/FCEN/report_Nanopore_seq.html). 

**Delivery 4**: [Apéndice experimental](appendix-experimental.qmd). 
...
En contraste, el esquema FastPGT representado en la **@fig-time-comparison** introduce una optimización simultánea de tiempos y costos a lo largo de todo el flujo. Esto incluye: 
...
## 5.1. Dinámica de la producción de secuencias
...
## 5.2. Dinámica del uso de poros y calidad de las secuencias
