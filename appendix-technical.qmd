...
**Insumos**: [Ligation sequencing amplicons - Native Barcoding Kit 24 V14](https://nanoporetech.com/document/ligation-sequencing-amplicons-native-barcoding-v14-sqk-nbd114-24). [Reporte Havanna - FCEN](inputs/FCEN/report_Nanopore_seq.html)
...
La detección de **CNVs** en cada cromosoma se basa en**comparaciones relativas de densidad de lecturas** entre regiones genómicas, evaluadas mediante ventanas móviles (*bins*) de tamaño fijo, típicamente del orden de **0.5–1 Mb**.
